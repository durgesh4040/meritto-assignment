...
import { FiMoreVertical } from "react-icons/fi"; // For the three-dot menu icon
import React, { useState } from "react";
import AddModule from "./AddModule";
import EditModule from "./EditModule";
import FileUpload from "./FileUpload";
import RenamePdfModal from "./RenamePdfModal"; // Import the RenamePdfModal
    ...
    <>
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 px-4">
        ...
        <div className="w-full max-w-4xl mx-auto mt-4">
          {modules.length === 0 && pdfs.length === 0 ? (
                    ...
                    {menuOpenId === module.id && (
                      <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded shadow-lg z-10">
                        ...
                        >
                          ...
                          <span className="px-6">Edit module name</span>
                        </a>
                        <a
                          href="#"
