    ...
    <section className="py-16 bg-gray-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-6">
        <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <p className="text-3xl font-bold text-gray-800 mb-4">Rs 19/month</p>
        ...
        <div className="bg-blue-100 p-6 rounded-lg shadow-lg border-2 border-blue-500">
          ...
          <p className="text-3xl font-bold text-gray-800 mb-4">Rs 49/month</p>
          <ul className="text-gray-600 mb-6">
            <li>10 Users</li>
            <li>50 GB Storage</li>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <p className="text-3xl font-bold text-gray-800 mb-4">Rs 99/month</p>
          <ul className="text-gray-600 mb-6">
